...
#+end_src
** package manager
*** COMMENT 设置package的源，这里选择[[https://elpa.emacs-china.org][emacs-china]]的melpa镜像地址
#+begin_src elisp
  (package-initialize)
...
#+end_src
*** 使用 straight [[https://www.ioiox.com/archives/62.html][1]]
- github...content 无法访问
  修改 host 文件
  linux: /etc/host
...
#+end_src
模板 [[https://www.reddit.com/r/emacs/comments/7zqc7b/share_your_org_capture_templates/][1]]
#+begin_src elisp
  (with-eval-after-load 'org
...
** emacs lisp mode
#+begin_src elisp
  ;;(setq elisp-load-path "d:/emacs/share/emacs/26.3/lisp/progmodes")

  (use-package highlight-defined
    :straight t
    :hook (emacs-lisp-mode . highlight-defined-mode))

  ;; (when (directory-name-p elisp-load-path)
  ;;   (use-package elisp-mode
  ;;     :load-path elisp-load-path
  ;;     :bind(:map emacs-lisp-mode-map ("DEL" . pes-smart-backspace)
  ;;                :map lisp-interaction-mode-map ("DEL" . pes-smart-backspace))
  ;;     :config
  ;;     (add-hook 'emacs-lisp-mode-hook
  ;;               #'(lambda ()
